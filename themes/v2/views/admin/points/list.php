...
<div class="table-toolbar">
    <div class="btn-group pull-left">
        <form class="form-inline">
            ...
            <div class="form-group">
                <?php echo CHtml::dropDownList('cate',$cate,$cates,array('class'=>'form-control chose_select','encode'=>false,'prompt'=>'--选择联赛--')); ?>
            </div>
             <div class="form-group">
                <?php echo CHtml::dropDownList('cate1',$cate1,$cates1,array('class'=>'form-control chose_select','encode'=>false,'prompt'=>'--选择球队--')); ?>
            </div>
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <tr>
        ...
        <th class="text-center">联赛</th>
        <th class="text-center">球队</th>
        <th class="text-center">场次</th>
        <th class="text-center">胜/平/负</th>
        <th class="text-center">进球/失球/净胜球</th>
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=$v->round?></td> 
            <td class="text-center"><?=$v->win.'/'.$v->same.'/'.$v->lose?></td><td class="text-center"><?=$v->score_ball.'/'.$v->lose_ball.'/'.($v->score_ball-$v->lose_ball)?></td>
            ...
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('/admin/team/edit',array('id'=>$v->id)); ?>" class="btn default btn-xs green"><i class="fa fa-edit"></i> 修改 </a>
