<?php
$this->pageTitle = '视频新建/编辑';
$this->breadcrumbs = array('视频管理', $this->pageTitle);
?>
...
<div class="form-group">
    <label class="col-md-2 control-label">视频摘要</label>
    <div class="col-md-8">
...
<div class="form-group">
    <label class="col-md-2 control-label">视频内容</label>
    <div class="col-md-8">
