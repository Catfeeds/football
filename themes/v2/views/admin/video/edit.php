...
<div class="form-group">
    <label class="col-md-2 control-label">比赛</label>
    <div class="col-md-8">
        <?php echo $form->dropDownList($article, 'mid', $cates, array('class' => 'form-control', 'encode' => false)); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->textField($article, 'link', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'link') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">直播平台名</label>
    <div class="col-md-4">
