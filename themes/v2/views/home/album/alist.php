                ...
                <div class="content">
                    <div class="archive-header">
                        <div class="dao_nav">
                            ...
                            <div class="dao_nav1_l fl"> <h1 style="font-size: 24px;margin-bottom:0;color: #00b7ee;border-bottom: 2px #00b7ee solid;padding-bottom: 8px;margin-left: 20px"><?=($cid?ArticleCateExt::model()->findByPk($cid)->name:($nowtag?($nowtag):'图库列表'))?></h1></div>
